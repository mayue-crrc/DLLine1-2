...
ROMDATA g_PicRom_RunHelp4[] =
{
    ...
    {QObject::trUtf8("逃生门状态"),                 D_FONT_BOLD(8),      QRect(41,  91, 158, 78),           Qt::white,                Qt::transparent,           CONTROL_LABEL,          ID_IGNORE         },
    {QObject::trUtf8("逃生门关闭"),                 D_FONT_BOLD(8),      QRect(201,  92, 108, 36),           Qt::white,                Qt::transparent,           CONTROL_LABEL,          ID_IGNORE         },
    {QObject::trUtf8("escape2.PNG"),                 D_FONT_BOLD(8),      QRect(331,  92, 68, 36),           Qt::black,                Qt::gray,           CONTROL_IMAGE,          ID_IGNORE         },
    {QObject::trUtf8("逃生门打开"),                 D_FONT_BOLD(8),      QRect(201, 132, 108, 36),           Qt::white,                Qt::transparent,           CONTROL_LABEL,          ID_IGNORE         },
    {QObject::trUtf8("escape1.PNG"),                 D_FONT_BOLD(8),      QRect(331,  132, 68, 36),           Qt::black,                Qt::blue,           CONTROL_IMAGE,          ID_IGNORE         },

    {QObject::trUtf8("乘客报警"),                D_FONT_BOLD(8),      QRect( 41, 172, 158,  36),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("乘客报警"),                D_FONT_BOLD(8),      QRect(201, 172, 108,  36),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE        },

     {QObject::trUtf8("warning.PNG"),           D_FONT_BOLD(8),      QRect(330, 172,  68,  36),           Qt::black,                Qt::green,                CONTROL_IMAGE,           ID_RUNHELP4_WARNING        },
    {QObject::trUtf8("相应车厢有乘客报警时显示"),  D_FONT_BOLD(8),      QRect(421, 172, 338,  36),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE        },

//    {QObject::trUtf8("被救援按钮"),                 D_FONT_BOLD(8),      QRect(60,  91+60, 108, 50),           Qt::white,                Qt::transparent,           CONTROL_LABEL,          ID_IGNORE         },
//    {QObject::trUtf8("被救援无效"),                 D_FONT_BOLD(8),      QRect(201,  91+60, 108, 28),           Qt::white,                Qt::transparent,           CONTROL_LABEL,          ID_IGNORE         },
//    {QObject::trUtf8("被救援无效"),                 D_FONT_BOLD(8),      QRect(311,  91+60, 108, 28),           Qt::black,                Qt::gray,           CONTROL_LABEL,          ID_IGNORE         },
//    {QObject::trUtf8("被救援有效"),                 D_FONT_BOLD(8),      QRect(201, 121+60, 108, 28),           Qt::white,                Qt::transparent,           CONTROL_LABEL,          ID_IGNORE         },
//    {QObject::trUtf8("被救援有效"),                 D_FONT_BOLD(8),      QRect(311,  121+60, 108, 28),           Qt::black,                Qt::blue,           CONTROL_LABEL,          ID_IGNORE         },
    
//    {QObject::trUtf8("被救援按钮说明:"),             D_FONT_BOLD(7),      QRect(50,  155+60, 700, 30),           Qt::white,                Qt::black,           CONTROL_LABEL,          ID_TEXT1         },
//    {QObject::trUtf8("正常情况下，牵引力大于10KN或80KN才缓解保持制动，按下“被救援”时，只要手柄在牵"),                 D_FONT_BOLD(7),      QRect(50,  185+60, 700, 30),           Qt::white,                Qt::black,           CONTROL_LABEL,          ID_TEXT2         },
//    {QObject::trUtf8("引位，不管有无牵引力，都缓解保持制动。"),                 D_FONT_BOLD(7),      QRect(50,  215+60, 700, 30),           Qt::white,                Qt::black,           CONTROL_LABEL,          ID_TEXT3         },
//    {QObject::trUtf8("在救援模式下，被救援车有两种方式缓解保持制动："),                 D_FONT_BOLD(7),      QRect(50,  245+60, 700, 30),           Qt::white,                Qt::black,           CONTROL_LABEL,          ID_TEXT4         },
//    {QObject::trUtf8("（1）在激活端司机室，按下“断高速断路器”按钮，并按下显示屏上的“被救援”按钮，"),                 D_FONT_BOLD(7),      QRect(50,  275+60, 700, 30),           Qt::white,                Qt::black,           CONTROL_LABEL,          ID_TEXT5         },
//    {QObject::trUtf8("     再将司控器手柄推到牵引位，即可缓解保持制动。"),                 D_FONT_BOLD(7),      QRect(50,  305+60, 700, 30),           Qt::white,                Qt::black,           CONTROL_LABEL,          ID_TEXT6         },
//    {QObject::trUtf8("（2）在激活端司机室，将司机室电器柜内的“强迫缓解”旋钮放到“合”，并将司控器"),                 D_FONT_BOLD(7),      QRect(50,  335+60, 700, 30),           Qt::white,                Qt::black,           CONTROL_LABEL,          ID_TEXT7         },
//    {QObject::trUtf8("     手柄推到惰行位，也可以缓解保持制动。"),                 D_FONT_BOLD(7),      QRect(50,  365+60, 700, 30),           Qt::white,                Qt::black,           CONTROL_LABEL,          ID_TEXT8         },
