...
#define ID_PICCARSET_BUTTON_LINE_3  0x0029
#define ID_PICCARSET_BUTTON_LINE_4  0x002A
#define ID_PICCARSET_BUTTON_LINE_5  0x002B

#define  ID_PICMAINTAIN_BUTTON_SCREENRECTIFY    0x0030
...
private:
    ...
    void SetLineTrainNum(int id, int lineNum, int trainNum);
