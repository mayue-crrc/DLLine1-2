#ifndef C_PAGE_CLEAR_RECORD_H
#define C_PAGE_CLEAR_RECORD_H
...
#define ID_PIBCR_BUTTON_TRACTIONENERGY        0x0002

#define ID_PIBCR_BUTTON_BRAKEENERGY        0x0022
...
#define ID_PIBCR_LABEL_REDTIME3       0x002F
...
protected:
    ...
    void OnTractionEnergyBtnClk();
    void OnBrakeEnergyBtnClk();
    ...
    void UpdateTractionEnergyBtn(int id, int colorVal);
    void UpdateBrakeEnergyBtn(int id, int colorVal);
    ...
    void SetRRun_Record_LabelString_long(int id, unsigned long DataVal);
    void SetRRun_Record_LabelString_long2(int id, unsigned long DataVal);
    void SetRRun_Record_TimeLabelString(int id, QString StringVal);
};



#endif // C_PAGE_CLEAR_RECORD_H
