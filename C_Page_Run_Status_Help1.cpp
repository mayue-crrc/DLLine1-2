...
//    {"",                            D_FONT_BOLD(6),      QRect(200, 480, 560,  1),           Qt::white,                Qt::black,                CONTROL_LINE,           ID_IGNORE         },
    ...
    {QObject::trUtf8("牵引/制动级位"),                   D_FONT_BOLD(8),      QRect( 41, 330,  158, 30),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE       },
    ...
    {QObject::trUtf8("惰行"),                  D_FONT_BOLD(8),       QRect(201, 271, 108, 28),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("牵引"),                  D_FONT_BOLD(8),       QRect(201, 308, 108, 28),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("制动 "),                 D_FONT_BOLD(8),       QRect(201, 354, 108, 28),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE        },
    ...
    {QObject::trUtf8(""),                      D_FONT_BOLD(8),       QRect(320, 185,  90, 20),          Qt::black,                Qt::white,                 CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("80A"),                   D_FONT_BOLD(8),       QRect(311, 211, 108, 28),          QColor(0,176,240),                Qt::black,                 CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8(""),                      D_FONT_BOLD(8),       QRect(320, 245,  90, 20),          Qt::white,                Qt::white,                 CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("惰行"),                  D_FONT_BOLD(8),       QRect(311, 271, 108, 28),          Qt::white,                Qt::black,                 CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("牵引 60%"),              D_FONT_BOLD(8),       QRect(320, 310,  90, 25),          Qt::black,                Qt::green,                 CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("制动 50%"),              D_FONT_BOLD(8),       QRect(320, 355,  90, 25),          Qt::white,                Qt::darkRed,               CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("紧急制动"),               D_FONT_BOLD(8),       QRect(320, 395,  90, 20),          Qt::white,                Qt::red,                   CONTROL_LABEL,           ID_IGNORE        },
    ...
    {QObject::trUtf8("不存在牵引和制动命令"),               D_FONT_BOLD(8),      QRect(421, 271, 338, 28),           Qt::white,      Qt::black,                CONTROL_LABEL,           ID_IGNORE        },
    {QObject::trUtf8("牵引有效/制动无效，0%-100%"),   D_FONT_BOLD(8),    QRect(421, 302, 338,40),   Qt::white,      Qt::black,                CONTROL_LABEL,           ID_IGNORE        },
//    {QObject::trUtf8("5%-10%默认为10%,90%-95%默认为90%"),             D_FONT_BOLD(D_FONT_BOLD(4)21, 323, 300,20),   Qt::white,      Qt::black,                CONTROL_LABEL,           ID_IGNORE        },

    {QObject::trUtf8("制动有效/牵引无效，0%-100%"),   D_FONT_BOLD(8),    QRect(421, 347, 338, 40),  Qt::white,      Qt::black,                CONTROL_LABEL,           ID_IGNORE        },
//    {QObject::trUtf8("5%-10%默认为10%,90%-95%默认为90%"),             D_FONT_BOLD(D_FONT_BOLD(4)21, 368, 300, 20),  Qt::white,      Qt::black,                CONTROL_LABEL,           ID_IGNORE        },
   ...
   {QObject::trUtf8("况下不显示故障三角"),            D_FONT_BOLD(8),      QRect(421, 481, 210, 28),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE         },
    ...
    {QObject::trUtf8("60 km/h"),                     D_FONT_BOLD(8),      QRect( 320, 515, 90, 20),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE         },
