...
#endif
    {QObject::trUtf8("   请输入4位密码。"),                      D_FONT_BOLD(10),       QRect( 40, 470, 160, 30),            Qt::white,                Qt::transparent,          CONTROL_LABEL,            ID_IGNORE         },
    {QObject::trUtf8("3个密码输入完毕后请点击右下角[确认]键。"), D_FONT_BOLD(10),       QRect( 23, 500, 450, 30),  Qt::white,                Qt::transparent,          CONTROL_LABEL,            ID_IGNORE         },
    {QObject::trUtf8("当前密码"),            D_FONT_BOLD(10),       QRect( 50, 170,  90, 25),           Qt::white,                Qt::transparent,          CONTROL_LABEL,            ID_IGNORE         },
    {QObject::trUtf8(""),                   D_FONT_BOLD(10),      QRect(170, 155, 230, 55),           Qt::white,                Qt::darkBlue,             CONTROL_EDIT,             ID_PIBPM_EDIT_PSDCUR        },
    {QObject::trUtf8("新密码"),              D_FONT_BOLD(10),       QRect( 50, 270,  70, 25),           Qt::white,                Qt::transparent,          CONTROL_LABEL,            ID_IGNORE         },
    {QObject::trUtf8(""),                   D_FONT_BOLD(10),      QRect(170, 255, 230, 55),           Qt::white,                Qt::darkBlue,             CONTROL_EDIT,             ID_PIBPM_EDIT_PSDNEW        },
    {QObject::trUtf8("确认新密码"),          D_FONT_BOLD(10),       QRect( 50, 370, 110, 25),           Qt::white,                Qt::transparent,          CONTROL_LABEL,            ID_IGNORE         },
    {QObject::trUtf8(""),                   D_FONT_BOLD(10),      QRect(170, 355, 230, 55),           Qt::white,                Qt::darkBlue,             CONTROL_EDIT,             ID_PIBPM_EDIT_PSDNEWAGAIN   },

    {QObject::trUtf8("7"),                  D_FONT_BOLD(10),       QRect(480, 150,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM7        },
    {QObject::trUtf8("8"),                  D_FONT_BOLD(10),       QRect(550, 150,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM8        },
    {QObject::trUtf8("9"),                  D_FONT_BOLD(10),       QRect(620, 150,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM9        },
    {QObject::trUtf8("4"),                  D_FONT_BOLD(10),       QRect(480, 220,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM4        },
    {QObject::trUtf8("5"),                  D_FONT_BOLD(10),       QRect(550, 220,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM5        },
    {QObject::trUtf8("6"),                  D_FONT_BOLD(10),       QRect(620, 220,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM6        },
    {QObject::trUtf8("1"),                  D_FONT_BOLD(10),       QRect(480, 290,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM1        },
    {QObject::trUtf8("2"),                  D_FONT_BOLD(10),       QRect(550, 290,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM2        },
    {QObject::trUtf8("3"),                  D_FONT_BOLD(10),       QRect(620, 290,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM3        },
    {QObject::trUtf8("0"),                  D_FONT_BOLD(10),       QRect(480, 360,  60, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_NUM0        },
    {QObject::trUtf8("清空"),               D_FONT_BOLD(10),       QRect(550, 360, 130, 60),           Qt::black,                Qt::gray,                 CONTROL_BUTTON,           ID_PIBPM_BUTTON_CLEAR       },
     ...
     this->InitPageHeader();
        ...
        void CPasswordModifyPage::OnComBtn6Clk()
        {
            ...
            if (psw == pw_true)
            {
               ...
               {
                   ShowWarningDialog(QObject::trUtf8("输入不一致!"));
               }
            }
            else
            {
