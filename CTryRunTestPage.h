...
#define ID_TRTP_LABEL_SPEEDMOMENT                  0X0087
#define ID_TRTP_LABEL_SHORKRATIO                   0X0088
...
private:
    ...
    QString updateTRTLevel(int nFlag);
...
protected:
    ...
    void UpdateSpeed();
    void updateSpeedMoment();
    void updateShorkRatio();
};
