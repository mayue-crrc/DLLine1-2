...
ROMDATA g_PicRom_Password[] =
{
   ...
   {QObject::trUtf8("请输入4位密码。"),      D_FONT_BOLD(8),      QRect( 40, 470, 150, 30),          Qt::white,                Qt::transparent,         CONTROL_LABEL,            ID_IGNORE         },
...
//                    }
               ...
               else
               {
                  ...
                  warningDlg.SetWarningStr(QObject::trUtf8("门参数密码错误,请重新输入!"));
